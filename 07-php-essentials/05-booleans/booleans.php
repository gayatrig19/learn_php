...
<body>
    <pre><?php
            ...
            // Floating-point representation in PHP can lead to precision issues because it uses binary approximations for decimal values, 
            // resulting in possible rounding errors during calculations, outputs bool(false)
            $amount = -10;
            $conversionRate = 0.3;
